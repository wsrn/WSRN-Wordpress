...
<!-- You can start editing here. -->
	...
	<?php 
		if ($comments) { 
	?>
			<h2 class="comments-title"><?php comments_number('No Responses', 'One Response', '% Responses' );?> to "<i><?php the_title(); ?></i>"</h2> 

			<ol class="comment-list">
				<?php wp_list_comments( array( 'type'=>'comment','before' => '<div class="navigation">' . __( '', '' ), 'after' => '</div>' ) ); ?>
			</ol>
	...
	?>			<br /><br />
				<h2 class="comments-title pings">Pings responses to this post</h2>
				<ul class="ping-list">
